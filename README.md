# 🏏 G-Cricket (Grade 11 Project)

> **Note:** This project was originally built during my Grade 11 Computer Science course. 
...
## 📂 The Code
The surviving fragment of the source code is available in the `partial_code/` folder for reference. It demonstrates the core logic used for [mention logic, e.g., random run generation or player classes].
